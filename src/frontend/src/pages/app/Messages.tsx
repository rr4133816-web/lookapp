...
export default function Messages() {
  ...
  // Simulated "other party is typing" indicator, reset whenever the thread changes.
  useEffect(() => {
    if (!activeId) return;
    setTyping(false);
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground">
          Keep every detail of a booking in one thread, before and after the
          session.
        </p>
      </header>
          ...
          <div className="flex min-h-[420px] flex-col lg:min-h-[560px]">
            <div className="flex items-center gap-3 border-b border-border/60 p-4">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-xs text-muted-foreground">
                  {active.online ? "Online now" : active.participantRole}
                </p>
              </div>
            </div>
