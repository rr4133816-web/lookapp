    ...
    services: [
      {
        ...
        description: "A full review of your current infrastructure with a prioritised remediation roadmap and cost forecast.",
        price: 420,
        durationMinutes: 90,
        popular: true
      },
      {
        ...
        description: "Hands-on planning for moving a specific workload to the cloud, including rollback and cutover steps.",
        price: 260,
        durationMinutes: 60
      },
      {
        ...
        description: "Assess whether your services are ready for Kubernetes and what to change before you commit.",
        price: 320,
        durationMinutes: 75
      }
    ],
    portfolio: [
      {
        ...
        description: "Moved a 40-service payments platform to multi-region ECS with zero customer-visible downtime.",
        image: "/assets/generated/portfolio-cloud.dim_960x640.jpg"
      },
      {
        id: "pf-01-2",
        title: "Cost reduction programme",
        description: "Cut monthly cloud spend by 38% across three business units without reducing capacity.",
    ...
    services: [
      {
        ...
        description: "A structured read of your repository with a prioritised list of what is blocking delivery.",
        price: 240,
        durationMinutes: 60,
        popular: true
      },
      {
        ...
        description: "A focused build session on one well-scoped feature, delivered as a reviewed pull request.",
        price: 380,
        durationMinutes: 120
      }
    ],
    portfolio: [
      {
        ...
        description: "Replaced a fragile checkout with a tested flow, lifting completed orders by 22%.",
    ...
    services: [
      {
        ...
        description: "A collaborative session mapping your attack surface and agreeing the controls that matter.",
        price: 480,
        durationMinutes: 120,
        popular: true
      },
      {
        ...
        description: "Manual testing of your web app with a written report and a remediation call.",
        price: 890,
        durationMinutes: 240
      }
    ],
    portfolio: [
      {
        ...
        description: "Took a 60-person SaaS company from no security programme to a clean SOC 2 Type II.",
    ...
    services: [
      {
        ...
        description: "A line-by-line review of your return before filing, with planning notes for next year.",
        price: 340,
        durationMinutes: 90,
        popular: true
      },
      {
        ...
        description: "Chart of accounts, reconciliation workflow and a clean opening balance in your accounting software.",
        price: 290,
        durationMinutes: 120
      },
      {
        ...
        description: "A short session to calculate and schedule your quarterly estimated payments.",
        price: 150,
        durationMinutes: 45
      }
    ],
    portfolio: [
      {
        ...
        description: "Reorganised four entities into a single filing structure, saving $41k in the first year.",
    ...
    services: [
      {
        ...
        description: "Rebuild a defensible set of accounts from incomplete or unreliable records.",
        price: 520,
        durationMinutes: 150,
        popular: true
      },
      {
        ...
        description: "Review of the financial evidence in a commercial dispute and a written summary of findings.",
        price: 380,
        durationMinutes: 90
      }
    ],
    portfolio: [
      {
        ...
        description: "Reconstructed three years of commingled accounts, supporting a settlement within six weeks.",
        image: "/assets/generated/portfolio-finance.dim_960x640.jpg"
      }
    ],
    credentials: [
    ...
    services: [
      {
        ...
        description: "A manufacturability pass on your CAD with tolerance, material and cost recommendations.",
        price: 360,
        durationMinutes: 90,
        popular: true
      },
      {
        ...
        description: "Turn a concept sketch into a parametric CAD model ready for prototyping.",
        price: 640,
        durationMinutes: 180
      }
    ],
    portfolio: [
      {
        ...
        description: "Designed a tool-free enclosure family that cut assembly time by 30%.",
    ...
    services: [
      {
        ...
        description: "Calculate demand, verify capacity and document what your panel can safely support.",
        price: 300,
        durationMinutes: 90,
        popular: true
      },
      {
        ...
        description: "Review of a control panel design against code and maintainability requirements.",
        price: 340,
        durationMinutes: 75
      }
    ],
    portfolio: [
      {
        ...
        description: "Redesigned distribution for a 60,000 sq ft facility to support a new conveyor line.",
        image: "/assets/generated/portfolio-engineering.dim_960x640.jpg"
      }
    ],
    credentials: [
    ...
    services: [
      {
        ...
        description: "Site review, massing options and a clear brief for your project before you commit to drawings.",
        price: 450,
        durationMinutes: 120,
        popular: true
      },
      {
        ...
        description: "Technical review of your drawing set against local code before submission.",
        price: 380,
        durationMinutes: 90
      }
    ],
    portfolio: [
      {
        ...
        description: "A 2,400 sq ft home on a steep lot, permitted first submission with no revisions.",
        image: "/assets/generated/portfolio-architecture.dim_960x640.jpg"
      },
      {
        id: "pf-08-2",
        title: "Adaptive reuse studio",
        description: "Converted a 1920s warehouse bay into a daylight-filled design studio.",
    ...
    services: [
      {
        ...
        description: "Rework a floor plan for better flow, storage and light, with two layout options.",
        price: 280,
        durationMinutes: 90,
        popular: true
      },
      {
        ...
        description: "A coordinated palette of finishes, fixtures and paint colours for your space.",
        price: 220,
        durationMinutes: 60
      }
    ],
    portfolio: [
      {
        ...
        description: "Replanned a 1,200 sq ft lobby around a central lounge, doubling usable seating.",
        image: "/assets/generated/portfolio-interior.dim_960x640.jpg"
      }
    ],
    credentials: [
    ...
    services: [
      {
        ...
        description: "A full review of your history, labs and goals, ending with a written plan you can follow.",
        price: 180,
        durationMinutes: 75,
        popular: true
      },
      {
        ...
        description: "Review progress, adjust the plan and work through the obstacles that came up.",
        price: 110,
        durationMinutes: 45
      }
    ],
    portfolio: [
      {
        ...
        description: "A 12-week cohort programme that brought 78% of participants into target range.",
    ...
    services: [
      {
        ...
        description: "Hands-on assessment, treatment and a staged rehabilitation plan for your injury.",
        price: 160,
        durationMinutes: 60,
        popular: true
      },
      {
        ...
        description: "Objective testing to confirm you are ready to return to training or competition.",
        price: 130,
        durationMinutes: 45
      }
    ],
    portfolio: [
      {
        ...
        description: "Guided a club runner from stress fracture to a personal best in eleven months.",
        image: "/assets/generated/portfolio-health.dim_960x640.jpg"
      }
    ],
    credentials: [
    ...
    services: [
      {
        ...
        description: "One-to-one work on the topics you are stuck on, with practice problems set afterwards.",
        price: 95,
        durationMinutes: 60,
        popular: true
      },
      {
        ...
        description: "A focused block covering past papers, timing strategy and the topics that cost you marks.",
        price: 210,
        durationMinutes: 120
      }
    ],
    portfolio: [
      {
        ...
        description: "Twelve students, eleven scoring a 5 and one a 4, from a school with no prior AP maths.",
    ...
    services: [
      {
        ...
        description: "Structured speaking practice with corrections and vocabulary notes sent afterwards.",
        price: 80,
        durationMinutes: 45,
        popular: true
      },
      {
        ...
        description: "Detailed marking of two essays against the official band descriptors.",
        price: 120,
        durationMinutes: 60
      }
    ],
    portfolio: [
      {
        ...
        description: "Coached 30 candidates over two years with a 93% pass rate at first attempt.",
        image: "/assets/generated/portfolio-tutoring.dim_960x640.jpg"
      }
    ],
    credentials: [
    ...
    services: [
      {
        ...
        description: "A guided session to define positioning, audience and the story your identity must tell.",
        price: 520,
        durationMinutes: 150,
        popular: true
      },
      {
        ...
        description: "A critique of your current identity with concrete directions for improvement.",
        price: 240,
        durationMinutes: 60
      }
    ],
    portfolio: [
      {
        ...
        description: "A full identity system rolled out across product, marketing and print in nine weeks.",
        image: "/assets/generated/portfolio-design.dim_960x640.jpg"
      },
      {
        id: "pf-14-2",
        title: "Specialty coffee packaging",
        description: "A flexible label system for twelve single-origin roasts on one print budget.",
    ...
    services: [
      {
        ...
        description: "A heuristic and flow review of your product with prioritised, testable recommendations.",
        price: 420,
        durationMinutes: 120,
        popular: true
      },
      {
        ...
        description: "Review your component library and agree the tokens, patterns and governance to adopt.",
        price: 380,
        durationMinutes: 90
      }
    ],
    portfolio: [
      {
        ...
        description: "Restructured a dense reporting tool, cutting time-to-insight from minutes to seconds.",
        image: "/assets/generated/portfolio-design.dim_960x640.jpg"
      }
    ],
    credentials: [
    ...
    services: [
      {
        ...
        description: "Systematic fault-finding with a written explanation of the cause and the fix.",
        price: 140,
        durationMinutes: 60,
        popular: true
      },
      {
        ...
        description: "Supply and install a Level 2 home charger, including permit paperwork.",
        price: 780,
        durationMinutes: 240
      },
      {
        ...
        description: "Assess whether your panel supports your plans and quote the upgrade if it does not.",
        price: 120,
        durationMinutes: 45
      }
    ],
    portfolio: [
      {
        ...
        description: "Rewired a 1940s house to current code while the family stayed in residence.",
    ...
    services: [
      {
        ...
        description: "Map your core processes, find the bottlenecks and agree a prioritised fix list.",
        price: 620,
        durationMinutes: 180,
        popular: true
      },
      {
        ...
        description: "Redesign one critical process end to end, with owners, metrics and a rollout plan.",
        price: 540,
        durationMinutes: 150
      }
    ],
    portfolio: [
      {
        ...
        description: "Cut invoice-to-payment time from 47 days to 19 across a 200-person distributor.",
    ...
    services: [
      {
        ...
        description: "Assess where your energy is going and build a realistic recovery plan for the next month.",
        price: 150,
        durationMinutes: 75,
        popular: true
      },
      {
        ...
        description: "Practical attention training for deep work, with a daily practice you can sustain.",
        price: 120,
        durationMinutes: 60
      }
    ],
    portfolio: [
      {
        ...
        description: "An eight-week resilience programme for a 40-person engineering org after a hard launch.",
