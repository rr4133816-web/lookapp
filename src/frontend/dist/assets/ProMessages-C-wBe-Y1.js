import { f as useApp, r as reactExports, j as jsxRuntimeExports, A as Avatar, e as cn, m as motion, X, M as MessageSquare } from "./index-Dpq2E7IO.js";
...
function ProMessages() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-1.5 font-display text-2xl font-bold tracking-tight md:text-3xl", children: "Client conversations" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground", children: "Answer questions, share preparation notes and keep every booking on track." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 overflow-hidden rounded-[calc(var(--radius)+4px)] border border-border/60 bg-card shadow-elevated lg:grid-cols-[320px_1fr] lg:gap-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-border/60 lg:border-r", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "max-h-[420px] overflow-y-auto lg:max-h-[560px]", children: filtered.map((conversation) => {
      ...
      active ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-[420px] flex-col lg:min-h-[560px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 border-b border-border/60 p-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-xs text-muted-foreground", children: active.online ? "Online now" : "Customer" })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "border-t border-border/60 p-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "sr-only", htmlFor: "pro-message-draft", children: "Write a message" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
